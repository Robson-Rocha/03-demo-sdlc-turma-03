...
| `durationHours` | inteiro | obrigatório, maior que zero e menor ou igual a quatro |
...
6. Dados válidos, incluindo uma carga horária de quatro horas, produzem `201`, um identificador e um recurso consultável depois da criação.
